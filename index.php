...
<html lang="en">
  	<head>
		...
		<meta name="description" content="Aplikasi BPAD">
	    <meta name="keywords" content="Aplikasi BPAD">
	    <meta name="author" content="Muhamad Iqbal WP">
  	...
  	<body>
  		<div class="container-fluid">
	    	<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
                <h5 class="my-0 mr-md-auto font-weight-normal text-info"><img src="./assets/img/bpad-logo-04b.png" alt="Logo"  widht=50 height=50> Pengelolaan Kendaraan Dinas</h5>
            <?php  
            ...
            <footer class="pt-4 my-md-4 pt-md-3 border-top">
                <div class="row">
                    <div class="col-12 col-md center">
                        &copy; 2024 - <a class="text-info" href="https://bpad.jakarta.go.id/">Pengelolaan Kendaraan Dinas BPAD</a>
                    </div>
                </div>
            </footer>
        </div>
